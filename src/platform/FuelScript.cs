...
public class FuelScript : MonoBehaviour
{
    ...
    void Start()
    {
		...
		// Make sound streams.
		_audio1 = new GameObject("audio1", typeof(FuelAudio));
		_audio2 = new GameObject("audio2", typeof(FuelAudio));
		_audio3 = new GameObject("audio3", typeof(FuelAudio));
		_audio4 = new GameObject("audio4", typeof(FuelAudio));
    ...
    // The Sole Instance
    //
    private static FuelScript _instance;
    ...
    {
        if (stream == 0)
            GameObject.Find("audio1").GetComponent<FuelAudio>().SetSource(wave);
        else if (stream == 1)
            GameObject.Find("audio2").GetComponent<FuelAudio>().SetSource(wave);
        else if (stream == 2)
            GameObject.Find("audio3").GetComponent<FuelAudio>().SetSource(wave);
        else
            GameObject.Find("audio4").GetComponent<FuelAudio>().SetSource(wave);
    }
    ...
    {
        if (stream == 0)
            GameObject.Find("audio1").GetComponent<FuelAudio>().SetSource(null);
        else if (stream == 1)
            GameObject.Find("audio2").GetComponent<FuelAudio>().SetSource(null);
        else if (stream == 2)
            GameObject.Find("audio3").GetComponent<FuelAudio>().SetSource(null);
        else
            GameObject.Find("audio4").GetComponent<FuelAudio>().SetSource(null);
    }
    ...
    public class FuelAudio : MonoBehaviour
	{
        ...
        unsafe void OnAudioFilterRead(float[] data, int channels)
        {
            ...
            {
                FuelScript.get_wave_samples(wave, (uint *)unsafePointer, samples);
                if (channels == 2)
                {
            ...
            if (FuelScript.is_wave_eos(wave))
                wave = null;
        }
    }
}
