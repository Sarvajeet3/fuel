...
/*
 * org.fueldev.engineandroid.MainActivity.nativeInitGame()
 */
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeInitGame(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeReinitOpenGL(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeCleanup(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
...
Java_org_fueldev_engineandroid_MainActivity_nativeRunFrame(
	JNIEnv *env,
	jobject instance)
{
	jni_env = env;
	...
	bool do_render = true;
	if (state_video) {
		jclass cls = (*jni_env)->FindClass(jni_env, "org/fueldev/engineandroid/MainActivity");
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeOnPause(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeOnResume(
        JNIEnv *env,
        jobject instance)
{
	jni_env = env;
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeOnTouchStart(
        JNIEnv *env,
        jobject instance,
        jint x,
        jint y,
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeOnTouchMove(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y)
...
JNIEXPORT void JNICALL
Java_org_fueldev_engineandroid_MainActivity_nativeOnTouchEnd(
	JNIEnv *env,
	jobject instance,
	jint x,
	jint y,
...
bool log_info(const char *s, ...)
{
	...
	__android_log_print(ANDROID_LOG_INFO, "fuel", "%s", buf);
	va_end(ap);
	return true;
}
...
bool log_warn(const char *s, ...)
{
	...
	va_start(ap, s);
	vsnprintf(buf, sizeof(buf), s, ap);
	__android_log_print(ANDROID_LOG_WARN, "fuel", "%s", buf);
	va_end(ap);
	return true;
}
...
bool log_error(const char *s, ...)
{
	...
	va_start(ap, s);
	vsnprintf(buf, sizeof(buf), s, ap);
	__android_log_print(ANDROID_LOG_ERROR, "fuel", "%s", buf);
	va_end(ap);
	return true;
}
