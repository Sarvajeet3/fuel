...
$TAR xzf ../../../lib/archive/brotli-1.1.0.tar.gz
cd brotli-1.1.0
$MAKE -j$NPROC -f ../../../../lib/make/brotli.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd bzip2-1.0.6
$MAKE -j$NPROC -f ../../../../lib/make/bzip2.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j$NPROC -f ../../../../lib/make/libwebp.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd zlib-1.3.1
$MAKE -j$NPROC -f ../../../../lib/make/zlib.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
sed \
    ...
    > pnglibconf.h
$MAKE -j$NPROC -f ../../../../lib/make/libpng.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j$NPROC -f ../../../../lib/make/jpeg.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j$NPROC -f ../../../../lib/make/libogg.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd libvorbis-1.3.7
$MAKE -j$NPROC -f ../../../../lib/make/libvorbis.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
patch src/gzip/zutil.h < ../../../../lib/patch/freetype.patch
$MAKE -j$NPROC -f ../../../../lib/make/freetype2.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
