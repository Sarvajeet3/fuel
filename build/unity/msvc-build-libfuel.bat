...
echo Building libfuel_proto.lib...
rd /s /q objs > NUL 2>&1
mkdir objs
cd objs
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/main.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/api.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/tag.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/vm.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/common.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /I../../../src ../../../src/render.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_UNITY /DUSE_CSHARP /DUSE_DLL /I../../../src ../../../src/platform/halwrap.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_UNITY /DUSE_CSHARP /DUSE_DLL /I../../../src ../../../src/platform/stdfile.c
...
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /DYY_NO_UNISTD_H /I../../../src ../../../src/lang/lexer.yy.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/parser.tab.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/ast.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/hir.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/lir.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/runtime.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/interpreter.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/intrinsics.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/jit-common.c
cl.exe /nologo /c /MT /O2 /DUNICODE /D_UNICODE /DUSE_JIT /I../../../src ../../../src/lang/jit-x86_64.c
lib.exe /nologo /OUT:libfuel_proto.lib main.obj api.obj tag.obj vm.obj common.obj render.obj halwrap.obj stdfile.obj glyph.obj wave.obj image.obj lexer.yy.obj parser.tab.obj ast.obj hir.obj lir.obj runtime.obj interpreter.obj intrinsics.obj jit-common.obj jit-x86_64.obj
cd ..

echo Merging libraries...
lib.exe /nologo /OUT:libfuel.lib objs/libfuel_proto.lib libroot/lib/zlib.lib libroot/lib/libpng.lib libroot/lib/jpeg.lib libroot/lib/libwebp.lib libroot/lib/libogg.lib libroot/lib/libvorbisfile.lib libroot/lib/libvorbis.lib libroot/lib/freetype.lib
rd /s /q objs > NUL 2>&1
rd /s /q libroot > NUL 2>&1
